/*
   ...
   one for UP and the other for DOWN navigation throw the array of Strings
   "Lines".
...
String lcdLines[LINES_SIZE] = {
    "LCD Line #1", "LCD Line #2", "LCD Line #3", "LCD Line #4", "LCD Line #5",
    "LCD Line #6", "LCD Line #7", "LCD Line #8", "LCD Line #9",
};
int columnIndex = 0;
